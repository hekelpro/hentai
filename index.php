...
<body>
  ...
  $nice = "http://209.126.6.6/series/?status=&type=&order=update";
  ...
  foreach ($z->find("div[class=hpage]") as $next){
    ...
    <br><br>
    <div class="button">
      <a href="index.php" class="btn btn-info btn-lg">REFRESH</a>
      <a href="next/next.php?url=http://209.126.6.6/series/<?= $nex; ?>" class="btn btn-info btn-lg">NEXT >></a>
    </div>
    <br><br>
    <?php
  }
